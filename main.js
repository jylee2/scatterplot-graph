...
const plotGraph = (data, svgElemId, tooltipId) => {
   ...
   const gYAxis = svgContainer.append("g")
                                 .call(yAxis)
                                 .attr("id", "y-axis")
                                 // Move y-axis to the right by svgPadding
   ...
   const scatter = svgContainer.selectAll("circle")
                                 ...
                                 .attr("data-xvalue", (d, i) => xAxisScale(d.Year))
                                 // Adding the requested "data-yvalue" property into the <rect> element
                                 .attr("data-yvalue", (d, i) => yPosScale(d.Seconds))
                                 ...
                                 .on("mouseover", (d) => {
                                    ...
                                    // tooltip should have a "data-year" property that corresponds to the "data-xvalue" of the active area
                                    return document.querySelector("#tooltip").setAttribute("data-year", xAxisScale(d.Year));
                                 })
                                 ...
                                 // **This is the actual tooltip to display data value when hover mouse on data point,
...
const readJson = (jsonURL) => {
   ...
   fetch(jsonURL)
      ...
      .then( (jsonObj) => {
         ...
         // Plot the graph by specifying (1) dataset & (2) which HTML Element Id to plot in & (3) which HTML Element to insert dummy tooltip
         plotGraph(jsonObj, "#insert-graph", "#tooltip");
      })
